...
public class AddMedical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView moneyFormate = (TextView) findViewById(R.id.add_medical_currency);
        moneyFormate.setText(sc.getMoney_format());
        ...
        if(medical_id!=-1){
            ...
            Log.d("addM_operation_type",String.valueOf(operation_name)+" " +String.valueOf(operation_type));
