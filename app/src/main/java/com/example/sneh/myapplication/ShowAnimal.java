...
public class ShowAnimal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("before_show_cicle_id", String.valueOf(cicle_id));
        Log.d("before_show_cicle_Sql", String.valueOf(cicle_sql));
        Log.d("before_show_build_sql", String.valueOf(building_sql));
        Log.d("before_show_building_id", String.valueOf(building_id));
        //setting intent
