...
public class AddDownPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] array_spinner = new String[worker_list.size()+1];
        array_spinner[0]=getResources().getString(R.string.select_worker);
        for(int i=1;i<worker_list.size()+1;i++){
            array_spinner[i]=worker_list.get(i-1).getName();
        }
        ...
        if(down_payment_id!=-1){
            ...
            for(int i=1;i<array_spinner.length;i++){
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(price.getText().toString().isEmpty() || spinner.getSelectedItemPosition() == 0){
