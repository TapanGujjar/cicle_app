...
public class Animals extends AppCompatActivity {
    ...
    int animal_id=-1, building_id, cicle_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("add_animal_building_sql",String.valueOf(building_sql));
        Log.d("add_animal_cicle_sql",String.valueOf(cicle_sql));
        Log.d("add_animal_user_id",String.valueOf(user_id));
        ...
        currency=(TextView)findViewById(R.id.add_animal_currency);
        ...
        //animal_id=handler.getAnimalCount(cicle_id,building_id);
        Log.d("add_aaaanimal_id", String.valueOf(animal_id));
        if(handler.getAnimalCount(cicle_id,building_id)==1 && animal_id==-1){
            Intent intent1=new Intent(Animals.this,ShowAnimal.class);
            Log.d("innn_intent_cicle", String.valueOf(cicle_id));
            Log.d("innn_intent_build",String.valueOf(building_id));
            intent1.putExtra("animal_id", handler.getAllAnimal(cicle_id, building_id).get(0).getAnimal_id());
            finish();
