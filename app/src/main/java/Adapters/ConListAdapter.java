...
import com.example.sneh.myapplication.ShowConsommation;
...
public class ConListAdapter extends BaseAdapter {
    ...
    public ConListAdapter(Context context, String[] text2, String[] text4, String[] text5,  String[] text6, String[] text7, int[] con_id) {
        this.text2 = text2;
        this.text4 = text4;
        this.text5 = text5;
        this.text6 = text6;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, ShowConsommation.class);
                i.putExtra("id",con_id[position]);
