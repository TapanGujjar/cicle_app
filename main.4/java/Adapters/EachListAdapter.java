package Adapters;
        ...
        import com.example.sneh.myapplication.ShowEgg;
...
public class EachListAdapter extends BaseAdapter {
    ...
    int j = 0;
    int[] id;
    Class[] contexts = {ShowEquipement.class, ShowWorker.class, ShowFood.class, ShowEgg.class, ShowDeath.class, ShowExpense.class, ShowDownPayment.class, ShowReturnedExpenses.class};
    Context context;
