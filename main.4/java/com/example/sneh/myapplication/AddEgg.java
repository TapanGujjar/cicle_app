...
public class AddEgg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        egg_ egg=handler.getEgg(egg_id);
        ...
        Log.d("Add_egg_egg_id", String.valueOf(egg_id));
        Log.d("Add_egg_cicle_id", String.valueOf(cicle_id));
        Log.d("Add_egg_building_id", String.valueOf(building_id));
